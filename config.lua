...
Config.Registers = {
    ...
    [33] = {vector3(271.3, -979.03, 29.37), robbed = false, time = 0, safeKey = 19, camId = 31},
    [34] = {vector3(269.02, -978.16, 29.37), robbed = false, time = 0, safeKey = 19, camId = 31},
}
...
Config.Safes = {
    ...
    [19] = {vector3(275.45, -984.71, 29.37), type = "keypad", robbed = false, camId = 32},
}
